import {
  v4_default
} from "./chunk-BWB5GZ2B.js";
import {
  require_jsx_runtime
} from "./chunk-SVNC244I.js";
import {
  require_browser_ponyfill
} from "./chunk-7NTUHJYB.js";
import {
  require_react
} from "./chunk-EZD5W4QT.js";
import {
  __commonJS,
  __export,
  __toESM
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef2 = React.useRef, useEffect3 = React.useEffect, useMemo = React.useMemo, useDebugValue = React.useDebugValue;
...
// node_modules/@yext/search-headless-react/lib/esm/src/useSearchActions.js
var import_react2 = __toESM(require_react());

// node_modules/@yext/search-headless-react/lib/esm/src/SearchHeadlessContext.js
...
// node_modules/@yext/search-headless-react/lib/esm/src/useSearchState.js
...
// node_modules/@yext/search-headless-react/lib/esm/src/useSearchUtilities.js
var import_react4 = __toESM(require_react());
function useSearchUtilities() {
  return (0, import_react4.useContext)(SearchHeadlessContext).utilities;
}

// node_modules/@yext/search-headless-react/lib/esm/src/subscribeToStateUpdates.js
var import_jsx_runtime = __toESM(require_jsx_runtime());
var import_react5 = __toESM(require_react());

// node_modules/@yext/search-headless-react/lib/esm/src/utils/isShallowEqual.js
function isShallowEqual(originalObj, newObj) {
...
function subscribeToStateUpdates(mapStateToProps) {
  const generateSubscriberHOC = (WrappedComponent) => {
    ...
    return function AnswersHeadlessSubscriber(props) {
      const answers = (0, import_react5.useContext)(SearchHeadlessContext);
      const [mergedProps, dispatch] = (0, import_react5.useReducer)(() => {
      ...
      return (0, import_jsx_runtime.jsx)(WrappedComponent, Object.assign({}, mergedProps), void 0);
    };
  };
  return generateSubscriberHOC;
}

// node_modules/@yext/search-headless-react/lib/esm/src/SearchHeadlessProvider.js
...
// node_modules/@yext/search-core/dist/esm/src/deprecated.js
...
var AnswersCore = function(_super) {
  __extends(AnswersCore2, _super);
  function AnswersCore2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  return AnswersCore2;
}(SearchCore);

// node_modules/@yext/search-core/dist/esm/src/models/searchservice/response/DirectAnswerType.js
...
// node_modules/@yext/search-core/dist/esm/src/transformers/core/createFilter.js
...
function createAppliedQueryFilter(data) {
  return __assign2({ displayKey: data.displayKey, displayValue: data.displayValue, filter: createFilter(data.filter), type: data.type }, data.details && { details: data.details });
}
...
// node_modules/@yext/search-core/dist/esm/src/constants.js
...
function isCombinedFilter(filter) {
  return filter.filters !== void 0 && filter.combinator !== void 0;
}
...
function shapeFacetOptionArrayForApi(options, fieldId) {
  return options.map(function(option) {
    return shapeFilterForApi(__assign3(__assign3({}, option), { fieldId }));
  });
}
...
function getClientSdk(additionalHttpHeaders) {
  ...
  return Object.entries(customClientSdk).reduce(function(clientSdk, _a2) {
    var _b;
    var agent = _a2[0], version4 = _a2[1];
    return version4 ? __assign4(__assign4({}, clientSdk), (_b = {}, _b[agent] = version4, _b)) : clientSdk;
  }, coreAgent);
}
...
var SearchError = function(_super) {
  __extends2(SearchError2, _super);
...
function provideCore(config) {
  ...
  var defaultedConfig = __assign9(__assign9({}, config), { endpoints: __assign9(__assign9({}, defaultEndpoints), config.endpoints) });
...
// node_modules/@yext/search-core/dist/esm/src/models/searchservice/request/CombinedFilter.js
...
function transformFiltersToCoreFormat(selectableFilters) {
  ...
  if (selectableFilters.length === 1) {
    const _a = selectableFilters[0], { selected, displayName: _2 } = _a, filter = __rest(_a, ["selected", "displayName"]);
  ...
  const groupedFilters = selectedFilters.reduce((groups, element) => {
    const { selected: _2, displayName: __ } = element, filter = __rest(element, ["selected", "displayName"]);
    groups[filter.fieldId] ? groups[filter.fieldId].push(filter) : groups[filter.fieldId] = [filter];
    return groups;
  }, {});
...
var MiddlewareArray = function(_super) {
  __extends3(MiddlewareArray2, _super);
...
function createSlice(options) {
  ...
  function buildReducer() {
    ...
    return createReducer(initialState12, finalCaseReducers, actionMatchers, defaultCaseReducer);
  }
  var _reducer;
  return {
    name,
...
var reducers3 = {
  ...
  setFilterOption: (state, { payload }) => {
    ...
    const { selected, displayName: _2 } = payload, targetFilter = __rest2(payload, ["selected", "displayName"]);
...
var SearchHeadless = class {
  ...
  async executeVerticalQuery() {
    ...
    const sessionTrackingEnabled = this.state.sessionTracking.enabled;
    const sessionId = this.state.sessionTracking.sessionId;
    const staticFilters = transformFiltersToCoreFormat(this.state.filters.static) || void 0;
...
// node_modules/@yext/search-headless/dist/esm/src/deprecated.js
var answersUtilities;
(function(answersUtilities2) {
  search_utilities_exports;
})(answersUtilities || (answersUtilities = {}));
var provideAnswersHeadless = provideHeadless;
var AnswersHeadless = class extends SearchHeadless {
};
...
function provideHeadless(config, additionalHttpHeaders) {
  const { verticalKey, headlessId } = config, searchConfig = __rest3(config, ["verticalKey", "headlessId"]);
...
// node_modules/@yext/search-headless-react/lib/esm/src/utils/acquireSessionId.js
...
// node_modules/@yext/search-headless-react/lib/esm/package.json
...
var { version: version3 } = package_default3;
function SearchHeadlessProvider(props) {
  const { children, verticalKey, sessionTrackingEnabled = true } = props, answersConfig = __rest4(props, ["children", "verticalKey", "sessionTrackingEnabled"]);
  const additionalHttpHeaders = {
    "Client-SDK": {
      ANSWERS_HEADLESS_REACT: version3
    }
  };
  ...
  return (0, import_jsx_runtime2.jsx)(SearchHeadlessContext.Provider, Object.assign({ value: answers }, { children }), void 0);
}

// node_modules/@yext/search-headless-react/lib/esm/src/deprecated.js
var AnswersHeadlessContext = SearchHeadlessContext;
function useAnswersActions() {
  return useSearchActions();
}
function useAnswersState(stateSelector) {
  return useSearchState(stateSelector);
}
function useAnswersUtilities() {
  return useSearchUtilities();
}
function AnswersHeadlessProvider(props) {
...
export {
  ...
  provideHeadless,
  search_utilities_exports as searchUtilities,
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=@yext_search-headless-react.js.map
