...
// node_modules/@yext/pages/dist/components/address/address.js
var Address = ({ address, lines, separator }) => {
  ...
  return React.createElement(React.Fragment, null, renderedLines);
};
...
// node_modules/@yext/pages/dist/components/image/image.js
var MKTGCDN_URL_REGEX = /(https?:\/\/a.mktgcdn.com\/p(-sandbox|-qa|-dev)?\/)(?<uuid>.+)\/(.*)/;
var Image = ({
  image,
  className,
  width,
  ...
  const [isImageLoaded, setIsImageLoaded] = (0, import_react.useState)(false);
  ...
  if (!imgUUID) {
    return React2.createElement(React2.Fragment, null, placeholder != null && placeholder);
  }
  ...
  return React2.createElement(React2.Fragment, null, !isImageLoaded && placeholder != null && placeholder, React2.createElement("img", {
    ref: imgRef,
    style: imgStyle,
    src,
    className,
...
var getImageUrl = (uuid, width, height) => {
  return `https://dynl.mktgcdn.com/p/${uuid}/${Math.round(width)}x${Math.round(
    height
  )}`;
};
var handleLayout = (layout, imgWidth, imgHeight, imgUUID, style, absWidth, absHeight, aspectRatio) => {
...
(function(urlParamNames2) {
  ...
  urlParamNames2["EntityInternalId"] = "id";
...
var PagesAnalyticsReporter = function() {
  ...
  PagesAnalyticsReporter2.prototype.urlParameters = function(event) {
    ...
    if (this._visitor) {
      ...
      if (this._visitor.method)
        params.set(urlParamNames.VisitorMethod, this._visitor.method);
    }
    return params;
  };
...
var AnalyticsContext = (0, import_react2.createContext)(null);
...
var ScopeContext = import_react3.default.createContext({ name: "" });
var useScope = () => {
  const ctx = import_react3.default.useContext(ScopeContext);
  return ctx.name;
};
function AnalyticsScopeProvider(props) {
  const parentScope = useScope();
  const combinedScope = concatScopes(parentScope, props.name);
  return import_react3.default.createElement(ScopeContext.Provider, {
...
function useAnalytics() {
  const ctx = (0, import_react4.useContext)(AnalyticsContext);
  if (!ctx) {
    return ctx;
  }
...
function AnalyticsProvider(props) {
  ...
  const analyticsRef = (0, import_react5.useRef)(null);
  ...
  return React4.createElement(AnalyticsContext.Provider, {
    value: analytics
  }, children);
}
...
var getHref = (cta2) => {
  if (cta2.linkType === "Email" || !cta2.linkType && isEmail(cta2.link)) {
    return `mailto:${cta2.link}`;
  }
  if (cta2.linkType === "Phone") {
